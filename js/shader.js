...
class Shader {
    constructor(gl, vertex_file, fragment_file, name) {
    ...
    getUniformLocation(name) {
        ...
        if (location == -1) {
            console.warn('Invalid uniform location encountered: ' + name)
        }
        return location
    ...
    /**
     * Sets a float scalar array uniform by location name
     * @param { String } name The name of the uniform
     * @param { Array<Number> } value The values of the scalar array
     */
